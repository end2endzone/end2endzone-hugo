...
Using *HDHomeRun TV Dump* is very easy, you just need to click the button that correspond to your desired activity: {{% windows-button3d %}}Scan{{% /windows-button3d %}}, {{% windows-button3d %}}Watch{{% /windows-button3d %}}, {{% windows-button3d %}}Record{{% /windows-button3d %}} and {{% windows-button3d %}}Program{{% /windows-button3d %}}. The step by step instructions are as follows: ## Scan
